...
public class MailService {
    ...
    public static void sendHelloMailWithLogo(Customer c) {
//        if (to == null) {
...
//        Session session = Session.getInstance(props);
        ...
        try {       
            ...
            message.setSubject("歡迎光臨，B3C電子網路商店");
            ...
            map.put("title", "B3C電子網路商店");
            map.put("memberName", c.getName());
            ...
            String filename = "ftl/3CLogo.png";
    ...
    public static void sendOrder(Order o) {
//      if (to == null) {
//          to = "carry.mo.tw@gmail.com";
//      }
...
//      Session session = Session.getInstance(props);
      ...
      try {       
          ...
          // Set 收件email: header field of the header.
          message.setRecipients(Message.RecipientType.TO, InternetAddress.parse(o.getRecipientEmail()));

          // Set Subject: header field
          message.setSubject("訂購明細，B3C電子網路商店");
          ...
          map.put("orderName", o.getRecipientName());
          map.put("oderdate", o.getOrderDate());
          map.put("orderTime", o.getOrderTime());
          map.put("addr", o.getShippingAddress());
